...
const setup = async (req, res) => {
  ...
  for (const filePath of settingsFiles) {
    ...
    const settingsToUpdate = {
      BillkolosSoft_app_email: email,
      BillkolosSoft_app_company_email: email,
      BillkolosSoft_app_timezone: timezone,
      BillkolosSoft_app_country: country,
      BillkolosSoft_app_language: language || 'en_us',
    };
  ...
  return res.status(200).json({
    success: true,
    result: {},
    message: 'Successfully BillkolosSoft App Setup',
  });
};
